...
export const MASTER_DATA_ENTITY_CONFIGS = {
  learningAreas: {
    ...
    navLabel: 'กลุ่มสาระ',
    singularLabel: 'กลุ่มสาระ',
    title: 'กลุ่มสาระการเรียนรู้',
    description:
      'จัดการกลุ่มสาระการเรียนรู้และสีประจำกลุ่มสาระที่ใช้ร่วมกับรายวิชา',
    schema: [
  ...
  subjects: {
    ...
    navLabel: 'รายวิชา',
    singularLabel: 'รายวิชา',
    title: 'รายวิชา',
    description:
      'จัดการรายวิชาของโรงเรียน พร้อมสีตามกลุ่มสาระ และประเภทวิชาพื้นฐานหรือเพิ่มเติม',
    schema: [
      { name: 'schoolId', type: 'string', required: true },
      { name: 'code', type: 'string', required: true },
      { name: 'name', type: 'string', required: true },
  ...
  teachers: {
    ...
    title: 'ครูผู้สอน',
    description:
      'จัดการข้อมูลครูสำหรับการจัดบุคลากร ครูประจำชั้น และการเป็นเจ้าของตารางสอน',
    schema: [
      { name: 'schoolId', type: 'string', required: true },
  ...
  students: {
    ...
    navLabel: 'นักเรียน',
    singularLabel: 'นักเรียน',
    title: 'นักเรียน',
    description:
      'จัดการข้อมูลนักเรียนและการสังกัดชั้นเรียน เพื่อรองรับการรายงานและการใช้งานตารางเรียน',
    schema: [
      { name: 'schoolId', type: 'string', required: true },
  ...
  classes: {
    ...
    navLabel: 'ชั้นเรียน',
    singularLabel: 'ชั้นเรียน',
    title: 'ชั้นเรียน',
    description:
      'จัดการชั้นเรียนตามระดับชั้นของไทย พร้อมกำหนดครูประจำชั้นได้',
    schema: [
      { name: 'schoolId', type: 'string', required: true },
      { name: 'code', type: 'string', required: true },
      { name: 'name', type: 'string', required: true },
  ...
  classrooms: {
    ...
    navLabel: 'ห้องเรียน',
    singularLabel: 'ห้องเรียน',
    title: 'ห้องเรียน',
    description:
      'จัดการห้องเรียน อาคาร ชั้น และความจุ เพื่อใช้ประกอบการจัดตารางสอน',
    schema: [
      { name: 'schoolId', type: 'string', required: true },
      { name: 'code', type: 'string', required: true },
      { name: 'name', type: 'string', required: true },
  ...
  activities: {
    ...
    navLabel: 'กิจกรรม',
    singularLabel: 'กิจกรรม',
    title: 'กิจกรรม',
    description:
      'จัดการกิจกรรมของโรงเรียน เช่น ชุมนุม กิจกรรมหน้าเสาธง กีฬา และกิจกรรมเสริม',
    schema: [
      { name: 'schoolId', type: 'string', required: true },
      { name: 'code', type: 'string', required: true },
      { name: 'name', type: 'string', required: true },
